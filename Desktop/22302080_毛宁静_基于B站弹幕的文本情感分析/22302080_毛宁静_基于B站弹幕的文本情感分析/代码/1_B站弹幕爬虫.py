...
if __name__ == "__main__":
	...
	# "up主"弹幕数较多的视频Bv号
	bv_list = ['BV1BY4y1X7zT', 'BV1D14y147tP', 'BV17V4y1x7Ya', 'BV1pU4y1z7nC', 'BV1PS4y1q7km']
	# 开始爬取
	for bv in bv_list:
		get_bilibili_danmu(v_url='https://www.bilibili.com/video/{}'.format(bv), v_result_file='弹幕.csv')
	print('爬虫程序执行完毕！')
